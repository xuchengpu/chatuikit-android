 ...
 */
class ChatUIKitMessageListScrollAndDataController(
    private val rvList: RecyclerView,
    private val adapter: ChatUIKitMessagesAdapter,
    ...
    fun setLoadDataType(loadDataType: ChatUIKitLoadDataType) {
    ...
    fun onScrollStateChanged() {
        if (ChatUIKitClient.getConfig()?.chatConfig?.showUnreadNotificationInChat == false) return
